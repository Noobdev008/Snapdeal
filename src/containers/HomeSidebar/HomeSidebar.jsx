...
export const HomeSidebar = ({ handleClick }) => {
    ...
    return (
        <div className={styles.topConten} >
            <div className={styles.sidemenu}>
                <ul className={styles.navarea}>
                    ...
                    <li className={styles.sidebarmain}><Link to={"/product/women"}>
                    ...
                    <li className={styles.sidebarmain}><Link to={"/product/kitchen"}>
                    ...
                    <li className={styles.sidebarmain}><Link to={"/product/kids"}>
                    ...
                    <li className={styles.sidebarmain}><Link to={"/product/beauty"}>
                    ...
                    <li><Link to={"/product/desc"}>High To Low</Link></li>
                    <li><Link to={"/product/asc"}>Low To High</Link></li>
                    <li><Link to={"/product/electronic"}>Electronics</Link></li>
                    <li><Link to={"/product"}>Automotives</Link></li>
                    <li><Link to={"/product"}>Mobile & Accessoriesh</Link></li>
                    <li><Link to={"/product"}>Electronics</Link></li>
                    <li><Link to={"/product"}>Sports, Fitness & Outdoor</Link></li>
                    <li><Link to={"/product"}>Computers & Gaming</Link></li>
                    <li><Link to={"/product"}>Books,Media & Music</Link></li>
